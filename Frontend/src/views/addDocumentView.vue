    ...
    <div class="w-full max-w-2xl">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
        ...
        <form @submit.prevent="envoyerDocument">
          ...
          <div @click="declencherInputFichier"
            ...
            <div
              class="w-14 h-14 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-gray-50">
            ...
            <input type="file" ref="inputFichier" class="hidden" @change="captureFichier"
          ...
          <div class="space-y-8">
            ...
            <div>
              <label class="block text-gray-700 mb-2"
                style="font-family: 'Mulish', sans-serif; font-weight: 600; font-size: 14px;">
                Titre du document
              </label>
            ...
            <div>
              ...
              <textarea v-model="description" required
                ...
                rows="4" placeholder="Ajoutez une description du document..."></textarea>
            </div>
            ...
            <div>
              ...
              <select v-model="service_id" required
          ...
          <div v-if="message" :class="isSuccess ? 'text-green-600 bg-green-50' : 'text-red-600 bg-red-50'"
            class="p-3 mt-8 rounded-lg text-center font-semibold text-sm">
            {{ message }}
          </div>

          <div class="flex items-center gap-4 mt-10 pt-8 border-t border-gray-50">
            <button type="button" @click="reinitialiser"
              class="flex-1 px-6 py-3.5 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
              style="font-family: 'Mulish', sans-serif; font-weight: 600; font-size: 15px;">
              Annuler
            </button>
            <button type="submit" :disabled="isLoading"
              class="flex-1 px-6 py-3.5 bg-[#0D9488] text-white rounded-lg hover:bg-[#0F766E] transition-colors shadow-sm disabled:opacity-50"
              style="font-family: 'Mulish', sans-serif; font-weight: 600; font-size: 15px;">
